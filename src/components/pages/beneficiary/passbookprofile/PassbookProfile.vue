                    ...
                    <!-- <table class="table"> -->
                        <v-data-table
                            ...
                            <template slot="items" slot-scope="props" >
                                ...
                                <td class="text-xs-left w-20">{{ props.item.slNo }}</td>
                                <td class="text-xs-left w-19">{{ props.item.nameOfHolder }}</td>
                                <td class="text-xs-left w-8">{{ props.item.issuedDate }}</td>
                                <td class="text-xs-left w-8">{{ props.item.validUpTo }}</td>   
                                ...
                                <td class="text-xs-left w-10 mr-3" v-if=" props.item.state ===0">
                                ...
                                <td class="text-xs-left w-10 mr-3" v-else-if=" props.item.state === 2">
                                    <span style="background-image: linear-gradient(to right, #7E685A, #7E685A); color: white; padding: 2px; border-radius: 2px; ">Profile Updated</span>
                                </td>
                    ...
                    <!-- <table class="table"> -->
                        <v-data-table
                            ...
                            <template slot="items" slot-scope="props" >
                                ...
                                <td class="text-xs-left w-15 mr-3" v-else-if=" props.item.state === 3">
                                    <span style="background-image: linear-gradient(to right, #4caf50 , #45772C); color: white; padding: 2px; border-radius: 2px; "> Articles Allocated </span>
                                </td>
                                <!-- <td class="text-xs-left w-12" v-else-if=" props.item.state >= 3">
                                <span style="background-image: linear-gradient(to right, #4caf50 , #45772C); color: white; padding: 2px; border-radius: 2px; "> Articles Allocated</span>
