...
<div class="asset-form">
    <div class="loading" v-if="progressBar.loading"></div>
        <div class="container-fluid">
            ...
            <br>
            <form class="form-group" @submit.prevent="exemptionProfileSaveUpdate()">                
                <div class="row">
                    <div class="col-12">
                        <div class="update-exemptionprofile">
                            <div class="mt-3">
                                <div class="row">                                     
                                        ...
                                        <div class="ml-3">
                                            <div class="col-10">                                                                                       
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="File Number" v-model="entity.fileNumber"  name="File Number" autocomplete="off" :disabled="this.entity.state >= 0"> 
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" placeholder="Holder Name" v-model="entity.nameOfHolder" v-validate="'required'" name="Holder Name" autocomplete="off" :readonly="checkState(this.entity.state)"> 
                                                ...
                                                <div class="mb-3">
                                                    <label> <b>Embassy Name</b></label>
                                                    <input class="form-control" placeholder="Embassy Name" v-model="entity.nameOfEmbassy"  name="Embassy Name" autocomplete="off"> 
                                                </div>
                                                <div class="mb-3">
                ...
                <div class="text-center mt-3">
                    ...
                    <button class="btn btn-success ripple mr-2"  @submit.prevent="exemptionProfileSaveUpdate()">
                        {{buttonText}}
                    </button>
                    <!-- <button class="btn btn-success ripple mr-2" @click="entity.state=2" @submit.prevent="exemptionProfileSaveUpdate()">
                        Submit
                    </button> -->
                    <router-link tag="button" class="btn btn-danger button-width ripple" :to="{name:'ExemptionProfile'}" >
                        Cancel
                    </router-link>
                </div>
            </form>
            <!-- <button class="btn btn-primary ripple mr-2" @click='getDownload()'> 
                Download File <i class="fa fa-download"></i>
            </button> -->

        <!-- <div v-if="this.entity.filePath">
            <button class="btn btn-success" @click='getDownload()'> Download File<i class="fa fa-download"></i></button>
        </div>             -->
    ...
    methods:{
        ...
        init(){
            ...
            if(this.$route.params.id){
                ...
                this.getexemptionProfile(this.$route.params.id)
            } else {
            ...
            this.$validator.validateAll().then(result => {
               ...
               if(this.entity.state === 1){
                ...
                .then(result => {
                    ...
                    this.color = "success"; 
                    if(this.$route.params.id){
                        this.messageText = "Exemption Profile Updated Successfully";
                        setTimeout( () => this.$router.push({name:'ExemptionProfile'}), 3000);
                    } else {
                        this.messageText = "Exemption Profile Saved Successfully";
