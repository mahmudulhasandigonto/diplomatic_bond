...
<div class="asset-form">
    <div class="loading" v-if="progressBar.loading"></div>
        <div class="container-fluid">
            ...
            <form class="form-group" @submit.prevent="embassySave()">
                        ...
                        <div class="new-office-info">
                            <div class="mt-3 ml-3 mr-3 mb-3">
                                ...
                                <div class="text-center mt-4">
                                    <button class="btn btn-success button-width ripple mr-3" @submit.prevent="embassySave()">
                                        {{buttonText}}
                                    </button>
    ...
    methods:{
        ...
        embassySave(){
            this.$validator.validateAll().then(result => {
                ...
                // } else {    
                http_url = url.master_basicprofile_v1_embassy_save;
                // }                
                // let body = this.modifier(this.entity); 
                if(this.honourierConsultant==true){
                    this.entity.type = "H";
                }
                ...
                .then(result => {
                    ...
                    if(this.$route.params.id){
                        ...
                        this.messageText = "Embassy Saved Successfully";
                        this.honourierConsultant = false;
