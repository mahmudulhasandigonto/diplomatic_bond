     ...
     <div class="">
        <div class="asset-top-panel">
            <div class="row col-12  nopadding">
                <router-link tag="button" class="btn btn-success ripple" style="background-color:#3f740d; border:none;" :to="{name:'New QuarterExemption'}">
                    <i class="fa fa-plus"></i>  
                    Add Quarter for Exemption
                </router-link>
        ...
        <div class="">
            ...
            <template slot="items" slot-scope="props" >
                ...
                <td class="text-center w-5">
                    <router-link 
                    tag="span" 
                    :to="{name:'Update QuarterExemption', params: { id: props.item.oid }}"
