    ...
    <div class="asset-form">
        <div class="loading" v-if="progressBar.loading"></div>
            <div class="container-fluid">
                <router-link :to="{ name: 'QuarterExemption' }"  tag="span" class="button-tooltip pt-1 float-left">
                ...
                <form class="form-group" @submit.prevent="quarterSaveUpdate()">
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-6 col-xl-6">
                            <div class="new-quarter-exemption">
                                <div class="mt-3 ml-3 mr-3 mb-3">
                                    <div class="mb-3">
                                        <label class="required"> <b>Quarter Name</b> Hints: 1st-quarter-2021 (January - March)</label>
                                        <input class="form-control mb-1" v-model="entity.oid"  placeholder="Exemption Quarter" v-validate="'required'" name="Quarter Name"/>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <datepicker placeholder="Date To" :bootstrap-styling = "true" calendar-class="filter-date" :clear-button="true" clear-button-icon="fa fa-times-circle" v-model="entity.dateTo"  name="Form To"></datepicker>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="text-center mt-4">
                                        ...
                                        <router-link tag="button" class="btn btn-danger button-width ripple" :to="{name:'QuarterExemption'}" >
                                            Cancel
                                        </router-link>
                                    </div>
                                </div>
...
export default {
    ...
    methods:{
        ...
        getQuarter(oid){
            ...
            let body = {oid: oid, quarterType: "quarterExemption"};
            console.log(body);
        ...
        quarterSaveUpdate(){
            this.$validator.validateAll().then(result => {
                ...
                this.entity.quarterType="quarterExemption";                
                ...
                .then(result => {
                    ...
                    if(this.$route.params.id){
                        ...
                        setTimeout( () => this.$router.push({name:'QuarterExemption'}), 3000);
                    } else {
