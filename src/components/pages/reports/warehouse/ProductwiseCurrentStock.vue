    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-4 col-4 mb-1">
              <model-list-select class="form-control-sm" :list="productList" v-model="dateEntity.productOid" option-value="oid" optionText="name" placeholder="Select Product Name" name="Product Name"/>
  ...
  methods: {    
    ...
    getShow(){
      this.$validator.validateAll().then(result => {
          ...
          let req = constant.getRequest(url.operation_report_v1_get_warehouse_product_list_parameter, body);
          lumos_client.onPost(url.operation_report_v1_get_warehouse_product_list_parameter, req)
          .then(result => {
