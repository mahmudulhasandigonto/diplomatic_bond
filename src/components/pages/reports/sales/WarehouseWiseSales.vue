      ...
      <div v-if="entity.length>0">
        ...
        >
          <template slot="items" slot-scope="props">
            ...
            <td class="text-xs-left">{{ props.item.numberOfSales }}</td>            
        ...
        <div class="container">
          <div class="row">
            <div class="col-xs-2 d-flex justify-content-end">
              <p><b>Total Number of Sales: </b>{{totalNumberOfSales}} </p>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-2 d-flex justify-content-end">   
  ...
  data() {
    return {
      ...
      warehouseHeaders: [
        ...
        { text: "Number Of Sales", value: "numberOfSales", align: "left" },
  ...
  methods: {    
    ...
    getShow(){
      ...
      this.entity = []
          ...
          let req = constant.getRequest(url.operation_report_v1_get_sales_list_parameter, body);
          lumos_client.onPost(url.operation_report_v1_get_sales_list_parameter, req)
          .then(result => {
              ...
              this.totalSalesPrice = result.data.body.total.totalSalesPrice
              this.totalSalesQuantity = result.data.body.total.totalSalesQuantity
              this.totalNumberOfSales = result.data.body.total.totalNumberOfSales
          }).catch(error =>{
          })
      });
    },   
