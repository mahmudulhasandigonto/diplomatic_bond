        ...
        <div v-if="entity.length>0">
          ...
          >
            <template slot="items" slot-scope="props">
              ...
              <td class="text-xs-left">{{ props.item.billOfEntryDate }}</td>
              <td class="text-xs-left">{{ props.item.billOfEntryOfficeCode }}</td>
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-2 d-flex justify-content-end">   
                <p><b>Total Sales Quantity: </b>{{entity1.totalSalesQuantity}}</p>
              </div>
            </div>
            <div class="row">
              <div class="col-xs-2 d-flex justify-content-end">
                <p><b>Total Sales Price: </b>{{entity1.totalSalesPrice}}</p>
              </div>
            </div>
          </div>
  ...
  data() {
    return {
      ...
      warehouseHeaders: [
        ...
        { text: "Bill of Entry Office", value: "billOfEntryOfficeCode", align: "left" },
  ...
  methods: {    
    ...
    getShow(){
      ...
      this.entity = []
          ...
          let req = constant.getRequest(url.operation_report_v1_get_ex_bond_parameter, body);
          lumos_client.onPost(url.operation_report_v1_get_ex_bond_parameter, req)
          .then(result => {
              this.entity1 = result.data.body.totalExBond;
